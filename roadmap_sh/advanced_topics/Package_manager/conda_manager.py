...
# Conda is an open source package manager and it helps you find and install packages

# If you need a package that requires a different version of Python, you do not need to switch to different enviroment
