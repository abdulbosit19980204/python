...
CHAT_ID = respose.json()['result'][0]['message']['chat']['id']
 ...
 'message': {'message_id': 136, 'from':
  {'id': 1209619850, 'is_bot': False, 'first_name': "To'ychiyev Abdulbosit (عبد الباسط)",
   'username': 'abdulbosit_tatu', 'language_code': 'en'},
    ...
    'date': 1703346079, 'text': '/start', 
    'entities': [{'offset': 0, 'length': 6, 'type': 'bot_command'}]}},
     {'update_id': 389398453, 'message': 
     {'message_id': 137, 'from': 
     {'id': 1209619850, 'is_bot': False, 'first_name': 
     "To'ychiyev Abdulbosit (عبد الباسط)", 'username': 'abdulbosit_tatu', 
     'language_code': 'en'}, 'chat': {'id': 1209619850, 'first_name': 
     "To'ychiyev Abdulbosit (عبد الباسط)", 'username': 'abdulbosit_tatu',
      'type': 'private'}, 'date': 1703346082, 'text': 'hello'}}]}
