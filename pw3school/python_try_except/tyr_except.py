...
# The finally block test you execute code, regardless of the result of the try- and except- blocks
...
try:
    ...
    # An exception occurred because x not defined
...
#Something went wrong when opening the file - when file doesn't exsist
...
#     raise TypeError("The type is not an integer")
#TypeError: The type is not an integer
